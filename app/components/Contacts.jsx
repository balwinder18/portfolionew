...
const Contacts = () => {
  return (
     <div className="mt-0 w-full py-10 mx-6 bg-black rounded-xl text-white text-lg flex flex-col justify-center items-center sm:mt-0 sm:py-10 sm:mx-14 sm:bg-black sm:rounded-xl  sm:text-white sm:text-lg sm:flex sm:flex-col sm:justify-center sm:items-center   md:mt-14 md:py-10 md:mx-20 md:bg-black md:rounded-xl  md:text-white md:text-lg md:flex md:flex-col md:justify-center md:items-center   lg:mt-14 lg:py-10 lg:mx-20 lg:bg-black lg:rounded-xl  lg:text-white lg:text-lg lg:flex lg:flex-col lg:justify-center lg:items-center   xl:mt-14 xl:py-10 xl:mx-20 xl:bg-black xl:rounded-xl  xl:text-white xl:text-lg xl:flex xl:flex-col xl:justify-center xl:items-center   2xl:mt-14 2xl:py-10 2xl:mx-20 2xl:bg-black 2xl:rounded-xl  2xl:text-white 2xl:text-lg 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center">
